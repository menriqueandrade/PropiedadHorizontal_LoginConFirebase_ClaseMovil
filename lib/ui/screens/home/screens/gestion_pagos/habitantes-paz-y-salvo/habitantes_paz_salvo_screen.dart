...
class ResidentesPazySalvo extends StatefulWidget {
  @override
  _ResidentesPazySalvoState createState() =>
      _ResidentesPazySalvoState();
}

class _ResidentesPazySalvoState extends State<ResidentesPazySalvo> {
