...
class AgregarAlquilerLudotecaUser extends StatefulWidget {
  final iddoc;
  final pos;
  final posicion;
  //final List<JuntaAdministrativa> juntaadmin;
  final List perfil;
  AgregarAlquilerLudotecaUser(
...
class _ModificarUsuarioState extends State<AgregarAlquilerLudotecaUser> {
