...
class ListaAreaLudotecaScreen extends StatefulWidget {
  @override
  _ListaAreaLudotecaScreenState createState() =>
      _ListaAreaLudotecaScreenState();
}

class _ListaAreaLudotecaScreenState extends State<ListaAreaLudotecaScreen> {
