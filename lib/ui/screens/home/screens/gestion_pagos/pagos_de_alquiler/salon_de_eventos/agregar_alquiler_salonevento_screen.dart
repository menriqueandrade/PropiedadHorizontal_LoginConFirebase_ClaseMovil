...
class AgregarAlquilerSalonEventoUser extends StatefulWidget {
  final iddoc;
  final pos;
  final posicion;
  //final List<JuntaAdministrativa> juntaadmin;
  final List perfil;
  AgregarAlquilerSalonEventoUser(
...
class _ModificarUsuarioState extends State<AgregarAlquilerSalonEventoUser> {
