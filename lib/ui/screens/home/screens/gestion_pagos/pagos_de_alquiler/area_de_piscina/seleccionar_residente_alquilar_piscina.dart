...
class SeleccionarResidenteParaAlquilarPiscinaScreen extends StatefulWidget {
  @override
  _SeleccionarResidenteParaAlquilarPiscinaScreenState createState() =>
      _SeleccionarResidenteParaAlquilarPiscinaScreenState();
}

class _SeleccionarResidenteParaAlquilarPiscinaScreenState
    extends State<SeleccionarResidenteParaAlquilarPiscinaScreen> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, posicion) {
          ...
          return ListTile(
            onTap: () {
               Get.to(() => AgregarAlquilerPiscinaUser(
